...
{
    public class UFOv3 : UFO
    {
        private Power statusPower;
        private readonly byte[] on_command = new byte[] { 0x71, 0x23, 0x0F, 0xA3 };
        private readonly byte[] off_command = new byte[] { 0x71, 0x24, 0x0F, 0xA4 };
        private int[] rgb_array = new int[] { 0x31, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x00 };
        ...
        public UFOv3(string name, string ip) : base(name, ip, 5577)
        {
